...
class TestCacheWarmer:
    ...
    def test_warm_all_success(self, mock_redis_manager):
        ...
        with patch.object(warmer, '_warm_active_users', return_value=1) as mock_active:
            with patch.object(warmer, '_warm_alert_settings', return_value=2) as mock_alert:
                with patch.object(warmer, '_warm_emergency_contacts', return_value=3) as mock_contact:
