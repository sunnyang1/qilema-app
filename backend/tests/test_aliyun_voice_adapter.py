...
from app.core.adapters.aliyun_voice_adapter import AliyunVoiceAdapter, create_aliyun_voice_adapter
...
class TestAliyunVoiceAdapterRealService:
    ...
    @patch("app.core.adapters.aliyun_voice_adapter.AliyunVoiceAdapter._init_aliyun_client")
    ...
    def test_error_code_mapping(self):
        """测试错误码映射"""
        assert AliyunVoiceAdapter._map_error_code("isv.BUSINESS_LIMIT_CONTROL") == "rate_limit_exceeded"
        assert AliyunVoiceAdapter._map_error_code("isv.AMOUNT_NOT_ENOUGH") == "insufficient_balance"
        assert AliyunVoiceAdapter._map_error_code("isv.INVALID_NUMBER") == "invalid_phone"
