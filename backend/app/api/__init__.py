...
from app.api import users, checkins, sos_requests, health_records, devices, knowledge, medications, aed, health_reports, anomalies, emergency_centers, emergency_resources, notifications, contacts, auth
...
api_router.include_router(health_reports.router, prefix="/health-reports", tags=["健康报告"])
...
api_router.include_router(emergency_centers.router, prefix="/emergency-centers", tags=["120急救中心"])
api_router.include_router(emergency_resources.router, prefix="/emergency-resources", tags=["急救资源"])
