...
async def list_categories(
    ...
    return ApiResponseBuilder.success(
        data=[c.to_dict() for c in categories], message="获取分类列表成功"
    )
...
async def get_category(category_id: int, db: DbSession):
    ...
    return ApiResponseBuilder.success(
        data=category.to_dict(include_children=True), message="获取分类详情成功"
    )
...
async def list_tags(
    ...
    return ApiResponseBuilder.success(
        data=[t.to_dict() for t in tags], message="获取标签列表成功"
    )
...
async def list_articles(
    ...
    return ApiResponseBuilder.success(
        data=[a.to_dict() for a in articles], message="获取文章列表成功"
    )
...
async def search_articles(
    ...
    return ApiResponseBuilder.success(
        data=[a.to_dict() for a in articles], message="搜索文章成功"
    )
...
async def get_article(article_id: int, db: DbSession):
    ...
    return ApiResponseBuilder.success(
        data=article.to_dict(include_content=True), message="获取文章详情成功"
    )
...
async def get_related_articles(
    ...
    return ApiResponseBuilder.success(
        data=[a.to_dict() for a in articles], message="获取相关文章成功"
    )
