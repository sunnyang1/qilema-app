...
class JPushAdapter(PushNotificationSimulator):
    ...
    def __init__(
        ...
        """
        super().__init__(enabled, success_rate, delay_ms, max_retries, retry_interval_ms, push_token)
        
        # 检查是否使用真实服务
        self.use_real_service = os.getenv("PUSH_USE_REAL_SERVICE", "false").lower() == "true"
    ...
    def bind_device(self, user_id: str, registration_id: str, device_type: str = "android") -> Dict[str, Any]:
        """绑定设备
    ...
    def send_by_tag(self, tags: List[str], title: str, content: str, 
